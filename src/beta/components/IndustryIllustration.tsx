...
import teamRoom from '../assets/team-room.png';
import operationsRoom from '../assets/operations-room.png';
...
export default function IndustryIllustration({ index }: { index: number }) {
  ...
  return <div className="industry-story-visual" data-scene={index}>
    {index === 0 && <Image src={teamRoom} alt="" fill sizes="(max-width: 700px) 100vw, 667px" className="chapter-photo"/>}
    <div className="industry-demo-sheet">
      <div className="industry-demo-brand"><Image src="/brand/exekova-mark.png" width={30} height={30} alt=""/><span>exekova</span><span>Example task</span></div>
  ...
  return <div className="industry-delivery">
    ...
    <div className="industry-delivery-grid">
      ...
      <div className="industry-delivery-visual">
        <Image src={operationsRoom} alt="" fill sizes="(max-width: 700px) 100vw, 708px" className="chapter-photo"/>
        <div className="industry-evidence-window"><div className="industry-window-sidebar"><Image src="/brand/exekova-mark.png" width={34} height={34} alt=""/><span>exekova</span><span><Icon name="file" size={14}/>Task</span><span><Icon name="branch" size={14}/>Repository</span><span><Icon name="check" size={14}/>Outcome</span></div><div className="industry-window-main"><span className="beta-label">EXAMPLE OUTCOME</span><h4>Tracking events.<br/><em>Verified.</em></h4><p>A focused change, with the evidence to review it.</p><ul><li><Icon name="check" size={16}/>Independent review</li><li><Icon name="check" size={16}/>Required checks</li><li><Icon name="check" size={16}/>Acceptance criteria</li></ul><div className="industry-window-footer"><Icon name="branch" size={18}/>Your team owns the merge.</div></div></div>
        <div className="industry-acceptance-receipt"><span>Acceptance record</span><Icon name="check" size={40}/><h4>A verified<br/><em>outcome.</em></h4><p>Code change.<br/>Review evidence.<br/>Check results.</p><div><Image src="/brand/exekova-mark.png" width={30} height={30} alt=""/>exekova</div></div>
      </div>
    </div>
  </div>;
}
