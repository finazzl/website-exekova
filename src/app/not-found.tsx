...
export default function NotFound() {
  return <div className="beta-page site-page"><section className="shell site-not-found" aria-labelledby="page-title"><div>
    ...
    <div className="site-actions"><Link href="/" className="beta-button">Back to the homepage<Icon name="arrow" size={18}/></Link><a href={REQUEST_ACCESS} className="beta-secondary">Request access<Icon name="arrow" size={15}/></a></div>
  </div></section></div>;
}
