  ...
  return <>
    ...
    <section className="site-section is-tight" id="contact-channels" aria-label="Contact form and channels"><div className="shell contact-layout">
      ...
      <div className="contact-channels">
        ...
        <article className="contact-channel"><span><Icon name="shield" size={20}/></span><div><h3>Privacy and legal</h3><p>Data requests, questions about a document, or anything for the people who look after them. See the <Link prefetch={false} href="/privacy">Privacy Policy</Link> and the <Link prefetch={false} href="/dpa">Data Processing Addendum</Link>.</p><a href={privacyMail}>Send a privacy request<Icon name="arrow" size={14}/></a></div></article>
        <article className="contact-channel"><span><Icon name="lock" size={20}/></span><div><h3>Already a customer?</h3><p>Sign in to the service to work on your tasks and outcomes.</p><Link prefetch={false} href={signInHref}>Sign in<Icon name="arrow" size={14}/></Link></div></article>
        <article className="contact-channel"><span><Icon name="search" size={20}/></span><div><h3>Questions first?</h3><p>Getting started, scope, review and verification, pricing, integrations and data are all answered on one page.</p><Link prefetch={false} href="/faq">Read the questions and answers<Icon name="arrow" size={14}/></Link></div></article>
      </div>
    </div></section>
