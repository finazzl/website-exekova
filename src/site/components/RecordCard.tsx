...
export default function RecordCard({ label, title, body, checks, foot, badge = 'Example', footIcon = 'branch' }: RecordCardProps) {
  return <div className="site-record">
    <div className="site-record-brand"><Image src="/brand/exekova-mark.png" width={26} height={26} alt=""/><span>exekova</span><span className="beta-badge" data-status="available">{badge}</span></div>
