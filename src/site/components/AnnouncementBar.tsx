...
export default function AnnouncementBar({ announcement }: { announcement?: Announcement }) {
  ...
  return <div className="site-announcement"><span><i aria-hidden="true"/>{announcement.label}</span><Link href={announcement.href}>{announcement.linkLabel}<Icon name="arrow" size={12}/></Link></div>;
}
