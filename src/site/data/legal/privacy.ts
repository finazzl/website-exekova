  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'The access request form on this site prepares an email in your own email application. Nothing is sent until you send it. The email contains what you entered: your work email address, company or team, task source and repository provider, an optional repository name, the task, and its acceptance criteria. If you download the request instead, the file stays on your device until you share it.' },
